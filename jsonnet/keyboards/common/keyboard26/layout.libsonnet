...
// 第三行的 7 个字母也走 1/11：原来是 0.085，那一行合计只有 0.9586，
// 右侧 shift 外侧会空出 4% 宽度。行1 用 0.085 是因为它有 10 个字母
// （10×0.085 + 0.15 = 1.0 刚好），第三行只有 7 个，比例不能照抄。
local ipadRow3LetterSize = { width: { percentage: 1 / 11 } };
