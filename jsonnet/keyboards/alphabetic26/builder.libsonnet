...

{
  ...
  build(context, keyboardLayout)::
    ...
    functionButtonStyles.genFuncKeyStyles(fontSize, color, theme, center, 'alphabetic') +
    ...
    // z 有下划（Tab），单独把它的长按气泡也接上下划前景，
    // 否则滑动时气泡里看不到下划目标。
    keyHelpers.hintStyles(['z'], 'alphabeticHintBackgroundStyle', true, true) +
