  ...
  build(context, layoutRoot, p26Layout)::
    ...
    } +
    {
      ...
      cn2enButton: p26Layout.cn2enButton {
        // 必须覆写 size：p26Layout 的中英键宽度是 26 键那一档（竖屏 1/10、
        // 横屏 146/784），套到九键底行就填不满 —— 九键底行是
        // 符号(1.5/7) + 空格(4/7) + 中英(1.5/7) = 7/7，
        // 用 26 键的宽度会在中英键右侧留一条缝。
        size: layout[sizeName].cn2enButton,
      },
