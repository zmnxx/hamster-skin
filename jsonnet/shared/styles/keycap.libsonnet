...
local gradientPalette = {
  light: {
    ...
    // 浮动面板（键盘菜单），说明见暗色那组
    '面板背景颜色': ['#FFFFFFF2', '#F2F2F7F7'],
    '面板描边颜色': '#00000014',
    '面板按键背景颜色-普通': ['#FFFFFFCC', '#F2F2F7A3'],
  ...
  dark: {
    ...
    // 浮动面板（键盘菜单）。面板整体是一块半透明深色玻璃板，按键比板面亮一档，
    // 靠描边与底边缘的反光做出浮起感 —— 与键帽同一套材质语言，但更轻。
    '面板背景颜色': ['#3A3A3CE8', '#26262AF2'],
    '面板描边颜色': '#FFFFFF1F',
    '面板按键背景颜色-普通': ['#7A7A8033', '#5A5A5E1F'],
    '面板按键背景颜色-高亮': ['#96969BE0', '#7C7C80D6'],
    '面板按键描边颜色-普通': '#FFFFFF26',
...
local defaultConfig = {
  ...
  insetsPanel: {
    portrait: { top: 5, left: 4, right: 4, bottom: 5 },
    landscape: { top: 4, left: 4, right: 4, bottom: 4 },
  },
  cornerRadiusPanel: 16,
  borderSize: 1,
  shadowOpacity: 0.08,
  shadowRadius: 4,
  hintCornerRadius: 10,
